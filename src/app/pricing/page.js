...
export default function PricePage() {
  ...
  const pricingPlans = [
    ...
    },
    {
      ...
      monthlyPrice: 4.99,
      yearlyPrice: 49.99, // ~$10 savings for annual billing
      features: [
        {
          category: "Document Processing",
          items: [
  ...
  const handleSubscribe = async (plan) => {
    ...
    try {
      ...
      const checkoutSessionRef = doc(db, "users", user.uid, "checkout_sessions", docRef.id);
      ...
      // Create a subscription document in a separate subscriptions collection
              ...
              <div
                ...
                className={`bg-white   border-2 ${
                  plan.popular 
                    ...
                    : "border-[#58b595]"
                } sketchy-box rounded-lg overflow-hidden transition-transform hover:scale-105`}
              >
                {plan.popular && (
                  <div className="absolute -top-3 -right-3 bg-[#e68a30] text-white px-3 py-1 rotate-12 sketchy-box">
                    Popular!
                  </div>
                )}
                ...
                <div className="px-4 pt-3 pb-4">
                  ...
                  <button
                    ...
                    disabled={processingPayment || (userSubscription?.plan === plan.id)}
                    className={`w-full px-3 py-1.5 text-white text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 transform hover:rotate-1 sketchy-button ${
