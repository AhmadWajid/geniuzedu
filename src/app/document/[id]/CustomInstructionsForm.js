...
export default function CustomInstructionsForm({ customInstructions, onInstructionsChange, icon = "notes" }) {
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative bg-white  ring-1 ring-gray-200/50 dark:ring-gray-700/50 rounded-lg p-6 shadow-lg dark:shadow-gray-950/50">
        <div className="flex justify-between items-center mb-3">
          ...
          <button className="text-xs text-[#58b595] dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300 transition-colors">
            Show Example
          </button>
        </div>
        <div className="relative">
          <textarea 
            ...
            className="w-full h-32 px-4 py-3 text-gray-700  bg-gray-50/50  /50 border border-gray-200  rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500/50 dark:focus:ring-pink-400/50 focus:border-transparent transition-all duration-200 placeholder:text-gray-400 dark:placeholder:text-gray-500" 
            maxLength="500" 
            autoComplete="off" 
            spellCheck="false"
