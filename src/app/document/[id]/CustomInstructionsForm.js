...
export default function CustomInstructionsForm({ customInstructions, onInstructionsChange, icon = "notes" }) {
  ...
  const getIcon = () => {
    if (icon === "notes") {
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-pink-500 ">
  ...
  return (
    <div className="relative group">
      ...
      <div className="relative bg-white  ring-1 ring-gray-200/50  rounded-lg p-6 shadow-lg ">
        <div className="flex justify-between items-center mb-3">
          ...
          <button className="text-xs text-[#58b595]  hover:text-indigo-700  transition-colors">
            Show Example
          </button>
        </div>
        <div className="relative">
          <textarea 
            ...
            className="w-full h-32 px-4 py-3 text-gray-700  bg-gray-50/50  /50 border border-gray-200  rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500/50  focus:border-transparent transition-all duration-200 placeholder:text-gray-400 " 
            maxLength="500" 
            autoComplete="off" 
            spellCheck="false"
