        ...
        <div className="max-w-md mx-auto pt-20 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Or{' '}
              <Link href="/login" className="font-medium text-[#58b595] hover:text-[#5aa613]">
          ...
          <div className="mt-8 bg-white py-8 px-4 shadow-sm rounded-lg sm:px-10">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-400 text-gray-700 hover:bg-gray-50 mb-6"
            >
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-gray-400 text-gray-700">
                  Full Name
                </label>
                <input
                  id="name"
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-gray-400 text-gray-700">
                  Email address
                </label>
                <input
                  id="email"
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-medium text-gray-400 text-gray-700">
                  Password
                </label>
                <input
                  id="password"
