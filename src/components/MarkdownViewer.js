        ...
        components={{
          h1: ({ node, ...props }) => (
            <h1 className="text-3xl font-bold bg-gradient-to-r from-[#58b595] to-[#fbbf24] 
              ...
              pb-4 mb-8 border-b-2 border-orange-200 " {...props} />
          ),
          h2: ({ node, ...props }) => (
          ...
          p: ({ node, children, ...props }) => {
            ...
            return parentLi ? (
              ...
              <p className="text-gray-600  leading-relaxed  text-lg" {...props}>{children}</p>
            );
          },
          strong: ({ node, ...props }) => (
          ...
          td: ({ node, ...props }) => (
            <td className="py-3 px-4 text-gray-700 " {...props} />
          ),
          ...
          code: ({ node, inline, className, children, ...props }) => {
            ...
            return !inline && match ? (
              <code className={`bg-gray-50   text-gray-800  rounded-md px-1.5 py-0.5 ${className}`} {...props}>
                {children}
              </code>
            ) : (
              <code className="bg-gray-50   text-gray-800  rounded-md px-1.5 py-0.5 font-mono text-sm" {...props}>
                {children}
              </code>
            );
          },
          ...
          pre: ({ node, ...props }) => (
            <pre className="bg-gray-50   rounded-lg p-4 my-6 overflow-auto shadow-inner
              border border-gray-200 " {...props} />
          ),
        }}
      />
    </div>
